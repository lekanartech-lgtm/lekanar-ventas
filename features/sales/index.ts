export type { Sale, SaleFormData, Plan, DocumentType, SaleDocument, RequestStatus, OrderStatus, AddressType } from './types'
export {
...
export { getSalesByUserId, getSaleById, getSalesBySupervisor, getAllSales, getPlans, getPlansByOperator, getSaleByIdForBackoffice, getDocumentTypesByOperator } from './queries'
